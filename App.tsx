            ...
            <div className="flex flex-col space-y-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-sm font-black text-white">info@styleincar.com</span>
                </div>
              </div>
            </div>
          </div>
...
const ContactPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:info@styleincar.com?subject=${encodeURIComponent(subject || 'Inquiry from Website')}&body=${encodeURIComponent(`Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`)}`;
        ...
        <div>
          ...
          <div className="space-y-8 md:space-y-12">
            ...
            <div className="flex items-start space-x-6 md:space-x-8">
              ...
              <div><h4 className="text-lg font-black uppercase tracking-widest mb-1">Email</h4><p className="text-gray-500 font-bold uppercase tracking-widest text-[10px] md:text-[11px]">info@styleincar.com</p></div>
            </div>
          </div>
        </div>
...
const WhatsAppFloat = () => (
  <a
    href="https://wa.me/971504178786"
    target="_blank"
    rel="noopener noreferrer"
    className="fixed bottom-6 right-6 z-50 w-14 h-14 md:w-16 md:h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform duration-300 group"
  >
    <svg
      viewBox="0 0 24 24"
